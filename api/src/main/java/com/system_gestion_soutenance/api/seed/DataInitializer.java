...
public class DataInitializer implements CommandLineRunner {
  ...
  private static final String PASSWORD =
      "$2a$10$AY8qLutbqcPipSj1wCrt8.kqsfsezlmzkPa3YXE5Y7blECJqNj0ei";
  ...
  public void run(String... args) {
    ...
    emailConfigRepo.save(
        new EmailConfig(
            1L, "", 587, "", "", "FSBM Soutenance", "noreply@soutenance.univh2c.ma", "tls"));
    documentConfigRepo.save(new DocumentConfig(1L, 10, "pdf,doc,docx", 5));
    generalSettingsRepo.save(
        new GeneralSettings(
            1L, "Université Hassan II", "", "Africa/Casablanca", "DD/MM/YYYY", true));
    defenseSettingsRepo.save(
        new DefenseSettings(1L, "08:00", "18:00", 30, 15, "2026-03-01", "2026-05-01"));
    ...
    // Phase 4: Faculty
    Faculty f1 =
        facultyRepo.save(new Faculty(null, "Faculté des Sciences Ben M'Sik", "FSBM", null, null));
    ...
    Teacher teacherT5 =
        saveTeacher("El Ghazi", "Hassan", "hassan@univh2c.ma", grades.get(2), dPhys);
    Teacher teacherT6 =
        saveTeacher("Benkirane", "Jamila", "jamila@univh2c.ma", grades.get(0), dBio);
    Teacher teacherT7 =
        saveTeacher("El Ouafi", "Rachid", "rachid@univh2c.ma", grades.get(1), dInfo);
    Teacher teacherT8 =
        saveTeacher("El Fekkak", "Khadija", "khadija@univh2c.ma", grades.get(2), dMath);
    Teacher teacherT9 = saveTeacher("Ben Omar", "Nabil", "nabil@univh2c.ma", grades.get(0), dPhys);
    Teacher teacherT10 =
        saveTeacher("El Kholti", "Samira", "samira@univh2c.ma", grades.get(1), dBio);
    Teacher teacherT11 =
        saveTeacher("El Idrissi", "Abdellah", "abdellah@univh2c.ma", grades.get(2), dInfo);
    Teacher teacherT12 =
        saveTeacher("Bensouda", "Fatiha", "fatiha@univh2c.ma", grades.get(0), dMath);
    Teacher teacherT13 =
        saveTeacher("El Mourabit", "Karim", "karim@univh2c.ma", grades.get(1), dPhys);
    Teacher teacherT14 =
        saveTeacher("El Hassani", "Latifa", "latifa@univh2c.ma", grades.get(2), dBio);
    ...
    record StudentSeed(
        String lastName, String firstName, String email, String cne, Major major, Level level) {}
    ...
    JuryRoleTemplate jrtPfe =
        juryRoleTemplateRepo.save(
            new JuryRoleTemplate(
                null,
                "Template PFE",
                DefenseType.PFE,
                List.of(
                    new TemplateRole("Président", 1, 30),
                    new TemplateRole("Rapporteur", 1, 35),
                    new TemplateRole("Examinateur", 1, 35))));
    JuryRoleTemplate jrtMemoire =
        juryRoleTemplateRepo.save(
            new JuryRoleTemplate(
                null,
                "Template Mémoire",
    ...
    JuryRoleTemplate jrtThese =
        juryRoleTemplateRepo.save(
            new JuryRoleTemplate(
                ...
                DefenseType.THESE,
                List.of(
                    new TemplateRole("Président", 1, 25),
                    new TemplateRole("Rapporteur", 2, 30),
    ...
    DefenseSession ds1 =
        defenseSessionRepo.save(
            new DefenseSession(
                null,
                "Soutenance PFE Printemps 2025",
                DefenseType.PFE,
    ...
    DefenseSession ds3 =
        defenseSessionRepo.save(
            new DefenseSession(
                null,
                "Soutenance PFE Printemps 2026",
                DefenseType.PFE,
                DefenseSessionStatus.ACTIVE,
                3,
                30,
                10,
    ...
    DefenseSession ds4 =
        defenseSessionRepo.save(
            new DefenseSession(
                null,
                "Soutenance Mémoire Printemps 2026",
                DefenseType.MEMOIRE,
                DefenseSessionStatus.SCHEDULED,
                4,
                45,
                15,
                LocalDate.of(2026, 6, 1),
    ...
    DefenseSession ds5 =
        defenseSessionRepo.save(
            new DefenseSession(
                null,
                "Soutenance Thèse Printemps 2026",
                DefenseType.THESE,
                DefenseSessionStatus.SCHEDULED,
                1,
                60,
    ...
    DefenseSession ds6 =
        defenseSessionRepo.save(
            new DefenseSession(
                null,
                "Soutenance Rattrapage 2026",
                DefenseType.PFE,
                DefenseSessionStatus.DRAFT,
                3,
                30,
                10,
    ...
    ProjSeed[] projSeeds = {
      new ProjSeed(
          ...
          "Développement d'une plateforme web pour la gestion des soutenances de PFE.",
          "PFE",
          "pending",
          teacherT3),
      new ProjSeed(
          "Application E-commerce Mobile",
          "Application mobile de vente en ligne avec recommandations personnalisées.",
          "PFE",
          "approved",
          teacherT4),
      new ProjSeed(
          "Plateforme IoT pour Smart Campus",
          "Plateforme IoT connectant les capteurs du campus universitaire.",
          "PFE",
          "pending",
          teacherT5),
      new ProjSeed(
          "Analyse Prédictive des Données Climatiques",
          "Analyse et prédiction des données climatiques avec deep learning.",
          "MEMOIRE",
          "approved",
          teacherT6),
      new ProjSeed(
          "Chatbot Intelligent pour Services Universitaires",
          "Chatbot intelligent basé sur NLP pour les services universitaires.",
          "THESE",
          "approved",
          teacherT7),
      new ProjSeed(
          "Système de Recommandation de Cours",
          "Système de recommandation de cours basé sur les compétences.",
          "PFE",
          "pending",
          teacherT8),
      new ProjSeed(
          "Application Blockchain pour Diplômes",
          "Application blockchain pour la vérification des diplômes.",
          "PFE",
          "approved",
          teacherT9),
      new ProjSeed(
          "Outil de Visualisation de Données Génomiques",
          "Outil de visualisation interactive de données génomiques.",
          "MEMOIRE",
          "approved",
          teacherT10),
      new ProjSeed(
          "Assistant Virtuel pour Bibliothèque",
          "Assistant virtuel pour la gestion de bibliothèque universitaire.",
          "PFE",
          "pending",
          teacherT11),
      new ProjSeed(
          "Système de Détection de Fraude Academique",
          "Système de détection de fraude académique par machine learning.",
          "THESE",
          "approved",
          teacherT12),
      new ProjSeed(
          "Robot Autonome de Livraison",
          "Conception d'un robot autonome pour la livraison intra-campus.",
          "PFE",
          "pending",
          teacherT13),
      new ProjSeed(
          "Application de Réalité Augmentée pour l'Anatomie",
          "Application mobile de réalité augmentée pour l'étude de l'anatomie.",
          "PFE",
          "approved",
          teacherT14),
      new ProjSeed(
          "Plateforme de E-Learning Adaptatif",
          "Plateforme d'apprentissage adaptatif utilisant l'IA.",
          "MEMOIRE",
          "approved",
          teacherT3),
      new ProjSeed(
          "Système de Reconnaissance Faciale",
          "Système de reconnaissance faciale pour la sécurité du campus.",
          "PFE",
          "pending",
          teacherT4),
      new ProjSeed(
          "Optimisation des Transports Urbains",
          "Optimisation des transports urbains avec algorithmes génétiques.",
          "THESE",
          "approved",
          teacherT5),
      new ProjSeed(
          "Jeu Sérieux pour l'Apprentissage de la Programmation",
          "Jeu sérieux pour l'apprentissage de la programmation orientée objet.",
          "PFE",
          "pending",
          teacherT6),
      new ProjSeed(
          "Application de Télémédecine",
          "Application de télémédecine avec consultation en ligne.",
          "MEMOIRE",
          "approved",
          teacherT7),
      new ProjSeed(
          "Système de Gestion d'Énergie Solaire",
          "Système de gestion intelligente de l'énergie solaire.",
          "PFE",
          "approved",
          teacherT8),
      new ProjSeed(
          "Outil d'Analyse de Sentiments Twitter",
          "Outil d'analyse des sentiments sur Twitter en temps réel.",
          "THESE",
          "pending",
          teacherT9),
      new ProjSeed(
          "Plateforme de Crowdfunding pour Projets Étudiants",
          "Plateforme de crowdfunding dédiée aux projets étudiants.",
          "PFE",
          "approved",
          teacherT10),
      new ProjSeed(
          ...
          teacherT11),
      new ProjSeed(
          "Application de Suivi de Présence NFC",
          "Application de suivi de présence utilisant la technologie NFC.",
          "MEMOIRE",
          "approved",
          teacherT12),
      new ProjSeed(
          "Générateur Automatique de Comptes Rendus",
          "Générateur automatique de comptes rendus de réunions.",
          "PFE",
          "pending",
          teacherT13),
      new ProjSeed(
          "Plateforme de Mentorat Étudiant",
          "Plateforme de mentorat connectant étudiants et professionnels.",
          "THESE",
          "approved",
          teacherT14),
      new ProjSeed(
          "Système de Notation Automatique de Copies",
          "Système de notation automatique de copies avec deep learning.",
          "PFE",
          "approved",
          teacherT3),
    };
    ...
    for (ProjSeed ps : projSeeds) {
      Project p =
          new Project(null, ps.title, ps.desc, ps.dtype, ps.status, ps.sup, new ArrayList<>());
    ...
    JmSeed[] jmSeeds = {
      new JmSeed(0, "Président", 1),
      new JmSeed(0, "Rapporteur", 2),
      new JmSeed(0, "Examinateur", 3),
      new JmSeed(1, "Président", 5),
      new JmSeed(1, "Rapporteur", 6),
      new JmSeed(1, "Examinateur", 7),
      new JmSeed(2, "Président", 9),
      new JmSeed(2, "Rapporteur", 10),
      new JmSeed(2, "Examinateur", 11),
      new JmSeed(3, "Président", 1),
      new JmSeed(3, "Rapporteur", 2),
      new JmSeed(3, "Examinateur", 3),
      new JmSeed(4, "Président", 5),
      new JmSeed(4, "Rapporteur", 6),
      new JmSeed(4, "Examinateur", 7),
      new JmSeed(5, "Président", 9),
      new JmSeed(5, "Rapporteur", 10),
      new JmSeed(5, "Examinateur", 11),
      new JmSeed(6, "Président", 1),
      new JmSeed(6, "Rapporteur", 2),
      new JmSeed(6, "Examinateur", 3),
      new JmSeed(7, "Président", 5),
      new JmSeed(7, "Rapporteur", 6),
      new JmSeed(7, "Examinateur", 7),
      new JmSeed(8, "Président", 9),
      new JmSeed(8, "Rapporteur", 10),
      new JmSeed(8, "Examinateur", 11),
      new JmSeed(8, "Examinateur", 0),
      new JmSeed(9, "Président", 2),
      new JmSeed(9, "Rapporteur", 3),
      new JmSeed(9, "Examinateur", 4),
      new JmSeed(9, "Examinateur", 5),
      new JmSeed(10, "Président", 7),
      new JmSeed(10, "Rapporteur", 8),
      new JmSeed(10, "Examinateur", 9),
      new JmSeed(10, "Examinateur", 10),
      new JmSeed(11, "Président", 0),
      new JmSeed(11, "Rapporteur", 1),
      new JmSeed(11, "Examinateur", 2),
      new JmSeed(11, "Examinateur", 3),
      new JmSeed(12, "Président", 5),
      new JmSeed(12, "Rapporteur", 6),
      new JmSeed(12, "Examinateur", 7),
      new JmSeed(12, "Examinateur", 8),
      new JmSeed(13, "Président", 10),
      new JmSeed(13, "Rapporteur", 11),
      new JmSeed(13, "Examinateur", 0),
      new JmSeed(13, "Examinateur", 1),
      new JmSeed(14, "Président", 3),
      new JmSeed(14, "Rapporteur", 4),
      new JmSeed(14, "Rapporteur", 5),
      new JmSeed(14, "Examinateur", 6),
      new JmSeed(14, "Examinateur", 7),
    };
    ...
    for (SlotSeed ss : slotSeeds) {
      slotAssignmentRepo.save(
          new SlotAssignment(
              null, ss.title, ss.date, ss.time, projects.get(ss.projIdx).getId(), ss.room));
    }
    ...
    List<EvalSeed> evalSeeds =
        Arrays.asList(
            ...
            new EvalSeed(
                ...
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(3).getId(),
                ds4.getId(),
                projects.get(3).getId(),
                "Président",
                12.2,
                "submitted",
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(4).getId(),
                ds5.getId(),
                projects.get(4).getId(),
                "Rapporteur",
                null,
                "pending",
                null),
            new EvalSeed(
                teachers.get(5).getId(),
                ds1.getId(),
                projects.get(5).getId(),
                "Examinateur",
                null,
                "pending",
                null),
            new EvalSeed(
                teachers.get(6).getId(),
                ds2.getId(),
                projects.get(6).getId(),
                "Président",
                17.4,
                "submitted",
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(7).getId(),
                ds3.getId(),
                projects.get(7).getId(),
                "Rapporteur",
                16.8,
                "submitted",
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(8).getId(),
                ds4.getId(),
                projects.get(8).getId(),
                "Examinateur",
                18.9,
                "submitted",
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(9).getId(),
                ds5.getId(),
                projects.get(9).getId(),
                "Président",
                null,
                "pending",
                null),
            new EvalSeed(
                teachers.get(10).getId(),
                ds1.getId(),
                projects.get(10).getId(),
                "Rapporteur",
                10.9,
                "submitted",
                LocalDateTime.of(2026, 6, 20, 10, 0)),
            new EvalSeed(
                teachers.get(11).getId(),
                ds2.getId(),
                projects.get(11).getId(),
                "Examinateur",
                null,
                "pending",
                null),
    ...
    List<DocSeed> docSeeds =
        Arrays.asList(
            new DocSeed(
                studentsList.get(0).getId(),
                "Rapport PFE",
                "report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(1).getId(),
                "Fiche de synthese",
                "summary",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(2).getId(),
                "Presentation",
                "presentation",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(4).getId(),
                "Rapport technique",
                "technical_report",
                "missing",
                null),
            new DocSeed(
                studentsList.get(5).getId(),
                "Manuel utilisateur",
                "user_manual",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(7).getId(),
                "Annexes",
                "appendices",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(8).getId(),
                "Rapport PFE",
                "report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(9).getId(), "Fiche de synthese", "summary", "missing", null),
            new DocSeed(
                studentsList.get(10).getId(),
                "Presentation",
                "presentation",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(11).getId(),
                "Poster",
                "poster",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(12).getId(),
                "Rapport technique",
                "technical_report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(13).getId(), "Manuel utilisateur", "user_manual", "missing", null),
            new DocSeed(
                studentsList.get(14).getId(), "Code source", "source_code", "missing", null),
            new DocSeed(
                studentsList.get(15).getId(),
                "Annexes",
                "appendices",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(17).getId(),
                "Fiche de synthese",
                "summary",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(18).getId(),
                "Presentation",
                "presentation",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(20).getId(),
                "Rapport technique",
                "technical_report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(21).getId(),
                "Manuel utilisateur",
                "user_manual",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(22).getId(),
                "Code source",
                "source_code",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(25).getId(),
                "Fiche de synthese",
                "summary",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(26).getId(), "Presentation", "presentation", "missing", null),
            new DocSeed(
                studentsList.get(27).getId(),
                "Poster",
                "poster",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(28).getId(),
                "Rapport technique",
                "technical_report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(29).getId(), "Manuel utilisateur", "user_manual", "missing", null),
            new DocSeed(
                studentsList.get(30).getId(),
                "Code source",
                "source_code",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(31).getId(),
                "Annexes",
                "appendices",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(32).getId(),
                "Rapport PFE",
                "report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(33).getId(), "Fiche de synthese", "summary", "missing", null),
            new DocSeed(
                studentsList.get(34).getId(), "Presentation", "presentation", "missing", null),
            new DocSeed(
                studentsList.get(35).getId(),
                "Poster",
                "poster",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(36).getId(),
                "Rapport technique",
                "technical_report",
                "missing",
                null),
            new DocSeed(
                studentsList.get(37).getId(),
                "Manuel utilisateur",
                "user_manual",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(38).getId(),
                "Code source",
                "source_code",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(40).getId(),
                "Rapport PFE",
                "report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(41).getId(),
                "Fiche de synthese",
                "summary",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(42).getId(),
                "Presentation",
                "presentation",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            ...
            new DocSeed(
                studentsList.get(44).getId(),
                "Rapport technique",
                "technical_report",
                "missing",
                null),
            new DocSeed(
                studentsList.get(45).getId(),
                "Manuel utilisateur",
                "user_manual",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(46).getId(), "Code source", "source_code", "missing", null),
            new DocSeed(
                studentsList.get(47).getId(),
                "Annexes",
                "appendices",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(48).getId(),
                "Rapport PFE",
                "report",
                "submitted",
                LocalDateTime.of(2026, 5, 25, 14, 0)),
            new DocSeed(
                studentsList.get(49).getId(), "Fiche de synthese", "summary", "missing", null));
    for (DocSeed doc : docSeeds) {
      String fp =
          doc.submitted != null
              ? "/uploads/"
                  + studentsList.get((int) (doc.sid - studentsList.get(0).getId()))
                  + "/"
                  + doc.name.toLowerCase().replace(" ", "_")
                  + ".pdf"
              : null;
      studentDocumentRepo.save(
          new StudentDocument(
              null, doc.sid, doc.name, doc.type, "2026-06-01", doc.status, doc.submitted, fp));
    }

    // Phase 21: Notifications
    record NotifSeed(
        String type, String title, String msg, int day, int month, boolean read, String actor) {}
    NotifSeed[] notifSeeds = {
      new NotifSeed(
          "info",
          "Nouvelle soutenance programmée",
          "Message détaillé pour nouvelle soutenance programmée.",
          10,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          ...
          "Message détaillé pour soumission de document.",
          11,
          5,
          true,
          "coord@univh2c.ma"),
      new NotifSeed(
          ...
          "Message détaillé pour rappel: date limite approche.",
          12,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          "error",
          "Changement de jury",
          "Message détaillé pour changement de jury.",
          13,
          5,
          true,
          "coord@univh2c.ma"),
      new NotifSeed(
          "reminder",
          "Note publiée",
          "Message détaillé pour note publiée.",
          14,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          "info",
          "Soutenance annulée",
          "Message détaillé pour soutenance annulée.",
          15,
          5,
          true,
          "coord@univh2c.ma"),
      new NotifSeed(
          ...
          "Message détaillé pour nouveau projet ajouté.",
          16,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          "success",
          "Date de soutenance modifiée",
          "Message détaillé pour date de soutenance modifiée.",
          17,
          5,
          true,
          "coord@univh2c.ma"),
      new NotifSeed(
          "error",
          "Feedback disponible",
          "Message détaillé pour feedback disponible.",
          18,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          ...
          "Message détaillé pour inscription confirmée.",
          19,
          5,
          true,
          "coord@univh2c.ma"),
      new NotifSeed(
          "info",
          "Session ouverte",
          "Message détaillé pour session ouverte.",
          20,
          5,
          true,
          "admin@univh2c.ma"),
      new NotifSeed(
          ...
          "Message détaillé pour compte rendu disponible.",
          21,
          5,
          true,
          "coord@univh2c.ma"),
    ...
    for (NotifSeed ns : notifSeeds) {
      notificationRepo.save(
          new AppNotification(
              ...
              ns.title,
              ns.msg,
              LocalDateTime.of(2026, ns.month, ns.day, 8 + (ns.day % 8), 0),
              ns.read,
              "/dashboard",
              ns.actor));
    }
    ...
    for (int i = 0; i < auditSeeds.length; i++) {
      ...
      String details =
          "Action "
              + as2.action.toLowerCase()
              + " effectuée sur "
              + as2.entity.toLowerCase()
              + " "
              + as2.entityId
              + ".";
      auditLogRepo.save(
  ...
  private Teacher saveTeacher(
      String lastName, String firstName, String email, Grade grade, Department dept) {
