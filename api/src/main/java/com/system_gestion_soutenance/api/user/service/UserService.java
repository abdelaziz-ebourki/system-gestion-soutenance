...
public class UserService {
  ...
  public UserDto createUser(CreateUserRequest request) {
    ...
    if (userRepository.findByEmail(request.email()).isPresent()) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Un utilisateur avec cet email existe déjà");
    }
    ...
    for (BulkCreateRequest.BulkUserEntry entry : request.users()) {
      ...
      User user =
          switch (role) {
            ...
            default ->
                throw new ResponseStatusException(
                    HttpStatus.BAD_REQUEST, "Rôle non supporté pour l'import en masse: " + role);
          };
  ...
  public UserDto updateUser(Long id, UpdateUserRequest request) {
    ...
    if (user instanceof Student student) {
      ...
      if (request.majorId() != null) {
        Major major =
            majorRepository
                .findById(request.majorId())
                .orElseThrow(
                    () ->
                        new ResponseStatusException(HttpStatus.BAD_REQUEST, "Filière introuvable"));
      ...
      if (request.levelId() != null) {
        Level level =
            levelRepository
                ...
                .orElseThrow(
                    () ->
                        new ResponseStatusException(HttpStatus.BAD_REQUEST, "Niveau introuvable"));
      ...
      if (request.gradeId() != null) {
        Grade grade =
            gradeRepository
                ...
                .orElseThrow(
                    () -> new ResponseStatusException(HttpStatus.BAD_REQUEST, "Grade introuvable"));
                ...
                .orElseThrow(
                    () ->
                        new ResponseStatusException(
                            HttpStatus.BAD_REQUEST, "Département introuvable"));
  ...
  public void deleteUser(Long id) {
    ...
    if (user instanceof Student && !projectRepository.findByStudentsId(id).isEmpty()) {
      throw new ResponseStatusException(
          HttpStatus.CONFLICT, "Impossible de supprimer cet étudiant car il est lié à des projets");
    }
  ...
  private Teacher createTeacher(CreateUserRequest request) {
    if (request.departmentId() == null) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Le champ departmentId est requis pour un enseignant");
    }
    ...
    Department dept =
        departmentRepository
            ...
            .orElseThrow(
                () ->
                    new ResponseStatusException(HttpStatus.BAD_REQUEST, "Département introuvable"));
  ...
  private Student createBulkStudent(BulkCreateRequest.BulkUserEntry entry) {
    ...
    Major major =
        majorRepository
            .findByName(entry.majorName())
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "Filière introuvable: " + entry.majorName()));
    Level level =
        levelRepository
            .findByName(entry.levelName())
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "Niveau introuvable: " + entry.levelName()));
  ...
  private Teacher createBulkTeacher(BulkCreateRequest.BulkUserEntry entry) {
    if (entry.departmentName() == null) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Le champ departmentName est requis pour un enseignant");
    }

    Department dept =
        departmentRepository
            .findByName(entry.departmentName())
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.BAD_REQUEST,
    ...
    if (entry.gradeName() != null) {
      Grade grade =
          gradeRepository
              .findByName(entry.gradeName())
              .orElseThrow(
                  () ->
                      new ResponseStatusException(
                          HttpStatus.BAD_REQUEST, "Grade introuvable: " + entry.gradeName()));
      teacher.setGrade(grade);
    }
    teacher.setDepartment(dept);
    return teacher;
