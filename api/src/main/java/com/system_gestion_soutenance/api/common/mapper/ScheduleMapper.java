...
public interface ScheduleMapper {
    ...
    ScheduleResponse toDto(SlotAssignment slot, Map<Long, Project> projectMap,
            Map<Long, List<String>> studentNamesMap);

    default String resolveProjectTitle(SlotAssignment slot, Map<Long, Project> projectMap) {
        if (slot.getProjectId() == null || projectMap == null) return "";
    ...
    default List<String> resolveStudentNames(SlotAssignment slot, Map<Long, List<String>> studentNamesMap) {
        if (slot.getProjectId() == null || studentNamesMap == null) return List.of();
