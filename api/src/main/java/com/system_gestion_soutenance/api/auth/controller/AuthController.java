...
public class AuthController {
  ...
  public ResponseEntity<Map<String, String>> forgotPassword(
    ...
    return ResponseEntity.ok(
        Map.of("message", "Si cet email existe, un lien de réinitialisation a été envoyé."));
  }
  ...
  @Operation(
      ...
      description =
          "Finds the user by verification token, sets the password and activates the account.")
  @ApiResponse(
      responseCode = "200",
      description = "Account verified",
      content =
          @Content(examples = @ExampleObject("{\"message\": \"Account verified successfully\"}")))
