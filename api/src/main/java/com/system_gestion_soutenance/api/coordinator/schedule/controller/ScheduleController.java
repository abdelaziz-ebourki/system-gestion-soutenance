...
public class ScheduleController {
  ...
  public ScheduleController(
      ScheduleService scheduleService, ConflictDetectionService conflictDetectionService) {
  ...
  public ResponseEntity<Map<String, Object>> autoGenerate(@RequestBody Map<String, String> body) {
    ...
    if (defenseSessionId == null) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Le champ 'defenseSessionId' est requis");
    }
    Map<String, Map<String, Object>> schedule =
        scheduleService.autoGenerate(Long.valueOf(defenseSessionId));
