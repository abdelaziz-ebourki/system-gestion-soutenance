...
public class DocumentDataService {
              ...
              .orElseThrow(
                  () ->
                      new ResponseStatusException(
                          HttpStatus.NOT_FOUND, "Soutenance non trouvée: " + id));

      Project project =
          slot.getProjectId() != null
    ...
    Project project =
        projectRepository
            ...
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Projet non trouvé: " + projectId));
  ...
  private Map<String, Object> buildDefenseData(SlotAssignment slot, Project project) {
    ...
    for (Jury jury : juries) {
      ...
      if (jury.getTemplate() != null && jury.getTemplate().getRoles() != null) {
        jury.getTemplate()
            .getRoles()
            .forEach(r -> coefficients.put(r.getName(), r.getCoefficient()));
      }
    }
  ...
  private List<Map<String, Object>> buildGroupedSlots() {
    ...
    slots.sort(
        Comparator.comparing((Map<String, Object> a) -> (String) a.get("date"))
