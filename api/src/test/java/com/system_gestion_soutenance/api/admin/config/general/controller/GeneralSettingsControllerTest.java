...
@WebMvcTest(
    controllers = GeneralSettingsController.class,
...
class GeneralSettingsControllerTest {
  ...
  @MockitoBean private GeneralSettingsService service;
  ...
  void get_returnsSettings() throws Exception {
    ...
    mockMvc
        .perform(get("/api/admin/config/general"))
  ...
  void update_passesRequestToService() throws Exception {
    ...
    verify(service)
        .update(argThat(req -> req.institutionName().equals("Univ") && req.setupCompleted()));
  }
}
