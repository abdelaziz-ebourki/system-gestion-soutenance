...
class EmailConfigServiceTest {
  ...
  void update_existing_updatesFields() {
    ...
    UpdateEmailConfigRequest req =
        new UpdateEmailConfigRequest(
            "new.host.com", 587, "user", "new-pass", "Sender", "s@s.com", "tls");
  ...
  void update_passwordNull_doesNotOverride() {
    ...
    UpdateEmailConfigRequest req =
        new UpdateEmailConfigRequest("h", 25, "u", null, "S", "e@e.com", "none");
    EmailConfig result = service.update(req);
