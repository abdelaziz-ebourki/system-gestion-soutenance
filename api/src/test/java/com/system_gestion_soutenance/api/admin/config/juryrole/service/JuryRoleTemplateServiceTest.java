...
class JuryRoleTemplateServiceTest {
  ...
  void create_success() {
    ...
    CreateJuryRoleTemplateRequest req =
        new CreateJuryRoleTemplateRequest(
            "Template PFE",
            "PFE",
  ...
  void create_duplicateName_throws() {
    when(juryRoleTemplateRepository.findByName("Template PFE"))
        .thenReturn(Optional.of(new JuryRoleTemplate()));
    CreateJuryRoleTemplateRequest req =
        new CreateJuryRoleTemplateRequest(
            "Template PFE",
            "PFE",
  ...
  @Test
  void update_success() {
    JuryRoleTemplate existing =
        new JuryRoleTemplate(1L, "Old", DefenseType.PFE, new java.util.ArrayList<>());
  ...
  void update_notFound_throws() {
    ...
    CreateJuryRoleTemplateRequest req =
        new CreateJuryRoleTemplateRequest(
            "X", "PFE", List.of(new CreateJuryRoleTemplateRequest.RoleEntry("Rôle", 1, 1)));
  ...
  void delete_success() {
    JuryRoleTemplate template =
        new JuryRoleTemplate(1L, "T", DefenseType.PFE, new java.util.ArrayList<>());
  ...
  void delete_withDefenseSessions_throws() {
    JuryRoleTemplate template =
        new JuryRoleTemplate(1L, "T", DefenseType.PFE, new java.util.ArrayList<>());
    when(juryRoleTemplateRepository.findById(1L)).thenReturn(Optional.of(template));
    when(defenseSessionRepository.findByJuryRoleTemplate_Id(1L))
        .thenReturn(List.of(new DefenseSession()));
