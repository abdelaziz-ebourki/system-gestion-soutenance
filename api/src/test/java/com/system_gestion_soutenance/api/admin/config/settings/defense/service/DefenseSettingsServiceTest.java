...
class DefenseSettingsServiceTest {
  ...
  void update_createNew_whenNotFound() {
    ...
    UpdateDefenseSettingsRequest req =
        new UpdateDefenseSettingsRequest("09:00", "17:00", 45, 10, "2026-06-01", "2026-06-30");
  ...
  void update_existing_updatesFields() {
    ...
    UpdateDefenseSettingsRequest req =
        new UpdateDefenseSettingsRequest("10:00", "16:00", 20, 5, null, null);
    DefenseSettings result = service.update(req);
