...
class UserServiceTest {
  ...
  void setUp() {
    ...
    studentRequest =
        new CreateUserRequest(
            "Doe", "John", "john@test.com", "student", "CNE123", 1L, 1L, null, null);
    teacherRequest =
        new CreateUserRequest(
            "Smith", "Jane", "jane@test.com", "teacher", null, null, null, 1L, 1L);
    coordinatorRequest =
        new CreateUserRequest(
            "Coord", "Bob", "bob@test.com", "coordinator", null, null, null, null, null);
  }
  ...
  void createUser_student_missingFields_throws() {
    CreateUserRequest bad =
        new CreateUserRequest("Doe", "John", "j@t.com", "student", null, null, null, null, null);
  ...
  void createUser_teacher_missingDepartment_throws() {
    CreateUserRequest bad =
        new CreateUserRequest("Smith", "J", "j@t.com", "teacher", null, null, null, null, null);
  ...
  void updateUser_updatesBasicFields() {
    ...
    UpdateUserRequest req =
        new UpdateUserRequest("New", "Name", null, null, null, null, null, null, null);
  ...
  void updateUser_duplicateEmail_throws() {
    User existing =
        new User(1L, "current@t.com", "", Role.STUDENT, "A", "B", true, null, null, null);
    ...
    UpdateUserRequest req =
        new UpdateUserRequest(null, null, "new@t.com", null, null, null, null, null, null);
  ...
  void deleteUser_student_hasProject_throws() {
    ...
    when(projectRepository.findByStudentsId(1L))
        .thenReturn(
            List.of(new com.system_gestion_soutenance.api.coordinator.project.entity.Project()));
  ...
  void bulkCreate_students_success() {
    var entry =
        new BulkCreateRequest.BulkUserEntry(
            "Doe", "John", "j@t.com", "CNE123", "GL", "S6", null, null);
  ...
  void bulkCreate_duplicateEmail_throws() {
    var entry =
        new BulkCreateRequest.BulkUserEntry(
            "Doe", "John", "j@t.com", "CNE123", null, null, null, null);
