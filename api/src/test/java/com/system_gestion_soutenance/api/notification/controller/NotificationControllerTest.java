...
class NotificationControllerTest {
  ...
  void findAll_returnsList() throws Exception {
    when(repository.findAllByOrderByTimestampDesc())
        .thenReturn(
            List.of(
                new AppNotification(
                    1L, "info", "Test", "Message", LocalDateTime.now(), false, null, null),
                new AppNotification(
                    2L, "warning", "Test 2", "Message 2", LocalDateTime.now(), true, null, null)));
  ...
  void markAllRead_returns204() throws Exception {
    AppNotification n1 =
        new AppNotification(1L, "info", "A", "Msg", LocalDateTime.now(), false, null, null);
    AppNotification n2 =
        new AppNotification(2L, "info", "B", "Msg", LocalDateTime.now(), false, null, null);
