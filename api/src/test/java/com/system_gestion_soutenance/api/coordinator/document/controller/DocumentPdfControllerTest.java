...
class DocumentPdfControllerTest {
	...
	@Test
	void procesVerbal_returnsPdf() throws Exception {
		when(documentDataService.procesVerbal(1L)).thenReturn(new ProcesVerbalResponse(
				new ProcesVerbalResponse.Settings(null, null, null, null), null, List.of(), null, List.of()));
